...
Their version tracks the Python one: `@cyvest/cyvest-js@7.2.0` reads the documents written by
`cyvest==7.2.0` (investigation schema `7.1.0`), as well as 7.0 documents.
See [JS packages](../js-packages.md).
